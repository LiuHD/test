...
Class Check
{
     ...
     */
    public function IsSame($ArgvOne, $ArgvTwo, $Force = false)
    {
     ...
     */
    public function IsNickname($Argv)
    {
     ...
     * 返回值:是返回参数,不是返回false
     */
    public function IsChinese($Argv, $Encoding = 'utf8')
    {
